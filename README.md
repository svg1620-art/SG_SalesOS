...
>
> **Этап 7 (текущий) — Кабинет менеджера.** Только свои звонки, тренд балла
> (линия Chart.js), агрегированные рекомендации по навыкам, частые упущенные
> моменты, блок «что улучшить на этой неделе». amoCRM и дневная сводка — далее.
...
Остальные задаются заранее, но используются позже: `CLAUDE_MODEL_DIGEST`,
`SCHEDULER_ENABLED`, `POLL_INTERVAL_MIN`, `DIGEST_HOUR`, `AMO_BASE_DOMAIN`,
