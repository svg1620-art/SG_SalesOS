...
>
> **Этап 4 (текущий) — Карточка звонка.** Плеер, скоркарта с радаром критериев
> (Chart.js), инлайн-подсветка упущенных моментов в транскрибации (по наведению —
> пояснение), рекомендации, саммери. Дашборд-данные и amoCRM — следующие этапы.
